...
class BuildGraph(InMemoryDataset):
    ...
    def process(self):
        ...
        receivers_all = []
        i = 0
        train_file = '../data/TKY_traj_train.txt'
        test_file = '../data/TKY_traj_test.txt'
        with open(train_file,'r') as f:
            ...
            with open(test_file, 'r') as f:
                for line in f.readlines():
                    if len(line) > 0:
                        ...
                        uid = int(re.split('\t', line)[0])
                        poi_list = re.split('\t', line)[1:]
                        poi_list_id = [int(i) for i in poi_list]
            ...
            df = pd.read_csv('../data/foursquare_NYC.geo', sep=',', header=None,
